...
namespace prueba
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        async void OnListViewItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            //DisplayAlert("Item Selected", selectedItem.ToString(), "Ok");
        ...
        void OnListViewItemTapped(object sender, ItemTappedEventArgs e)
        {
            ...
            System.Diagnostics.Debug.WriteLine("tapped item:" + " " + tappedItem);
        }

        void OnButtonClicked(object sender, EventArgs args)
        {
            System.Diagnostics.Debug.WriteLine("onclickevent:");
            Monkeys.Add(
                new Monkey
                {
                    Name = "Mono titi",
            ...
            MyListView.ItemsSource = Monkeys;
        ...
        public void OnDelete(object sender, EventArgs e)
        {
            ...
            Monkeys.Remove( Monkeys.First(r => r.ToString() == mi.CommandParameter.ToString()));
            MyListView.ItemsSource = null;
            MyListView.ItemsSource = Monkeys;
        }
        ...
        public MainPage()
        {
            ...
            MyListView.RefreshCommand = new Command(() => {
                //Do your stuff.    
                System.Diagnostics.Debug.WriteLine("Refreshing event:");
